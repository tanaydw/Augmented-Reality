...
class CameraManager(object):
    ...
    def setup_camera(self):
        ...
        self.camera = world.spawn_actor(self.camera_blueprint(world), camera_transform)
        weak_self = weakref.ref(self)
...
def game_loop(args):
    ...
    try:
        ...
        while True:
            bounding_boxes = ClientSideBoundingBoxes.get_bounding_boxes(vehicles, world.camera_manager.camera)
