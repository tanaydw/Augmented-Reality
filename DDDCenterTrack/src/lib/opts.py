...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--debug', type=int, default=0,
                                 help='level of visualization.'
                                      ...
                                      '3: use matplot to display'  # useful when lunching training ipython notebook
        ...
        self.parser.add_argument('--load_model', default='/content/drive/MyDrive/ColabNotebooks/model_last_5.pth',
        ...
        self.parser.add_argument('--video_h', type=int, default=720, help='')
        self.parser.add_argument('--video_w', type=int, default=1080, help='')
        ...
        # model
        self.parser.add_argument('--arch', default='dla_34', help='model architecture. Currently tested'
        ...
        self.parser.add_argument('--down_ratio', type=int, default=4, help='downsampling 4.')
        ...
        self.parser.add_argument('--lr_step', type=str, default='60', help='drop learning rate by 10.')
        self.parser.add_argument('--save_point', type=str, default='90', help='when to save the model to disk.')
        ...
        self.parser.add_argument('--val_intervals', type=int, default=10000, help='number of epochs to run validation.')
        self.parser.add_argument('--trainval', action='store_true', help='include validation in training and '
                                                                         'test on test set')
        ...
        self.parser.add_argument('--keep_res', action='store_true', help='keep original resolution during validation')
        ...
        self.parser.add_argument('--model_output_list', action='store_true', help='Used when convert to onnx')
        ...
        self.parser.add_argument('--amodel_offset_weight', type=float, default=1, help='Please forgive the typo.')
    ...
    def parse(self, args=''):
        ...
        opt.ignore_loaded_cats = [int(i) for i in opt.ignore_loaded_cats.split(',')] \
    ...
    def update_dataset_info_and_set_heads(opt, dataset):
        ...
        opt.head_conv = {head: [opt.head_conv \
                                for _ in range(opt.num_head_conv if head != 'reg' else 1)] for head in opt.heads}
    ...
    def init(self):
        default_dataset_info = {
            'kitti_ddd': 'kitti',
            'nuscenes_ddd': 'nuscenes',
            'kitti_tracking_ddd': 'kitti',
            'nuscenes_tracking_ddd': 'nuscenes',
            'custom': 'custom'
        }
        opt = self.parse()
